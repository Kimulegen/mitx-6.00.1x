...
To get started, download the [ps6.zip](https://courses.edx.org/assets/courseware/v1/a3239690f87a97bb3be2e75b0917bf38/asset-v1:MITx+6.00.1x+2T2024+type@asset+block/ps6.zip) file. Extract it to your working directory. The files inside are:
