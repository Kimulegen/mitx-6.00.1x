...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i,letter in enumerate(lower_letters):
            dict.update({letter: lower_letters[(i+shift)%26]})
        for i,letter in enumerate(upper_letters):
            dict.update({letter: upper_letters[(i+shift)%26]})
...
plaintext = PlaintextMessage('this is a message', 2)
print('Expected Output: jgnnq')
print('Actual Output:', plaintext.get_message_text_encrypted())
    
#Example test case (CiphertextMessage)
ciphertext = CiphertextMessage('vjku ku c oguucig')
...
story= decrypt_story(get_story_string())[-1]
print(story)